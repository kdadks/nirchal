...
import { Plus, Trash2, Edit, Truck, ExternalLink } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <DeleteConfirmationModal
        ...
        title="Delete Logistics Partner"
        description="Are you sure you want to delete this logistics partner? This action cannot be undone and may affect existing orders."
        itemType="logistics partner"
        singleItemName={
          deleteTarget ? logisticsPartners?.find(p => p.id === deleteTarget)?.name : undefined
        }
        consequences={[
          'Partner information and contact details',
          'All tracking configurations',
          'Existing order associations',
          'Partner history and analytics'
        ]}
