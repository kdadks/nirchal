    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <section className="bg-gradient-to-r from-primary-600 to-accent-600 text-white rounded-xl shadow-lg p-8 mb-10 text-center">
          ...
          <p className="text-xl text-primary-100 mb-2">Your privacy is important to us. This policy explains how Nirchal collects, uses, and protects your personal information.</p>
        </section>
        <section className="bg-white rounded-xl shadow p-8">
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Information We Collect</h2>
          <ul className="list-disc ml-6 text-gray-700 mb-4">
            <li>Personal details (name, email, address, phone)</li>
            <li>Order and payment information</li>
            <li>Browsing and usage data</li>
          </ul>
          <h2 className="font-semibold text-xl mb-2 text-primary-700">How We Use Your Information</h2>
          <ul className="list-disc ml-6 text-gray-700 mb-4">
          ...
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Data Security</h2>
          ...
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Your Rights</h2>
          <ul className="list-disc ml-6 text-gray-700 mb-4">
