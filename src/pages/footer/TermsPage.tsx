    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <section className="bg-gradient-to-r from-primary-600 to-accent-600 text-white rounded-xl shadow-lg p-8 mb-10 text-center">
          ...
          <p className="text-xl text-primary-100 mb-2">By using Nirchal, you agree to our terms and conditions. Please read them carefully before making a purchase.</p>
        </section>
        <section className="bg-white rounded-xl shadow p-8">
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Use of Website</h2>
          <ul className="list-disc ml-6 text-gray-700 mb-4">
            <li>All content is for personal, non-commercial use only</li>
            <li>Do not misuse or copy our content or images</li>
          </ul>
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Orders & Payments</h2>
          <ul className="list-disc ml-6 text-gray-700 mb-4">
            <li>Orders are subject to acceptance and availability</li>
            <li>We reserve the right to refuse or cancel orders</li>
          </ul>
          <h2 className="font-semibold text-xl mb-2 text-primary-700">Liability</h2>
