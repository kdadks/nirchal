    ...
    <div className="container mx-auto px-4 py-6 md:py-8 pt-20 md:pt-24">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-serif font-bold text-gray-900">Store Locator</h1>
        </div>
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 md:pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm md:text-base"
                value={searchQuery}
